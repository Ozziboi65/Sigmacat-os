...
# when using an VM use legacy Bios uefi does not work
...
# Warning:
# I am not resposiable for anything you do with this, please use an virtual machine.
